        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('brands.update', $brand->id) }}" method="POST" data-toggle="validator">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Name *</label>
                                        <input type="text" name="name" class="form-control" placeholder="Enter Name" value="{{ old('name', $brand->name) }}" required>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="logo_path" id="logoPath" value="{{ old('logo_path', $brand->logo_path) }}">
        ...
        $(document).ready(function() {
            ...
            let brandDropzone = new Dropzone("#brandLogoDropzone", {
                ...
                init: function() {
                    ...
                    @if($brand->logo_path)
                        let existingLogo = '{{ $brand->logo_path }}';
            ...
            $('#removeLogo').change(function() {
                if ($(this).is(':checked')) {
                    if (brandDropzone.files.length > 0) {
                        brandDropzone.removeFile(brandDropzone.files[0]);
                    }
                    $('#logoPath').val('');
                }
            });
