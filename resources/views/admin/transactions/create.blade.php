                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="type" class="form-control" required>
                                            ...
                                            <option value="income" {{ (isset($transaction) && $transaction->type == 'income') ? 'selected' : '' }} {{ old('type') == 'income' ? 'selected' : '' }}>Income</option>
                                            <option value="expense" {{ (isset($transaction) && $transaction->type == 'expense') ? 'selected' : '' }} {{ old('type') == 'expense' ? 'selected' : '' }}>Expense</option>
                                            <option value="transfer" {{ (isset($transaction) && $transaction->type == 'transfer') ? 'selected' : '' }} {{ old('type') == 'transfer' ? 'selected' : '' }}>Transfer</option>
                                        </select>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" name="amount" class="form-control" 
                                            ...
                                            value="{{ isset($transaction) ? $transaction --}}
